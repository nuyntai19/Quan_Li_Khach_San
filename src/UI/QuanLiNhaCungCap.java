...
public class QuanLiNhaCungCap extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLiNhaCungCap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            QuanLiNhaCungCap quanLiPhong = new QuanLiNhaCungCap(); // Tạo đối tượng QuanLiPhong
